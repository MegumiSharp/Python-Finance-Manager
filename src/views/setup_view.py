...
class SetupView(BaseView):
    ...
    def setup_ui(self):
        ...
        self.title_label = customtkinter.CTkLabel(self.sidebar_frame,  text=WELCOME_HEADER_TEXT, font=customtkinter.CTkFont(size=20, weight="bold"))
        self.title_label.grid(row=0, column=0, padx=20, pady=(20, 10))

        # Welcome text-box in the sidebar
        self.welcome_textbox = customtkinter.CTkTextbox(self.sidebar_frame, width=260, height=310) 
        ...
        self.error_label = customtkinter.CTkLabel(self.sidebar_frame, text="", text_color="#BB4E62", anchor="w", font=("Arial", 12, "bold"))
        ...
        self.bg_image = customtkinter.CTkImage(Image.open(os.path.join(BACKGROUND_PATH, "background.jpg")), size=(WINDOW_WIDTH-300, WINDOW_HEIGHT))
        self.bg_image_label = customtkinter.CTkLabel(self.main_content_frame, text="", image=self.bg_image) # Trick to set background image
        self.bg_image_label.place(x=0, y=0, relwidth=1, relheight=1) 

        # Info textbox at the top
        self.info_textbox = customtkinter.CTkTextbox(self.main_content_frame, height=300)
        ...
        self.input_guide_textbox = customtkinter.CTkTextbox(self.input_guide_frame, height=120)
